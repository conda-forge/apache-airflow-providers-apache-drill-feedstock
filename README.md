About apache-airflow-providers-apache-drill
===========================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/apache-airflow-providers-apache-drill-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14184&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/apache-airflow-providers-apache-drill-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `apache-airflow-providers-apache-drill` can be installed with:

```
conda install apache-airflow-providers-apache-drill
```

It is possible to list all of the versions of `apache-airflow-providers-apache-drill` available on your platform with:
